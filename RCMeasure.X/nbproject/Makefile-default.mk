...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/RCMeasure.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Drivers/SYSTEM_Driver.c Drivers/INTERRUPT_Driver.c Drivers/UART_Driver.c Drivers/CTMU_Driver.c configuration.c main.c utils.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Drivers/SYSTEM_Driver.o ${OBJECTDIR}/Drivers/INTERRUPT_Driver.o ${OBJECTDIR}/Drivers/UART_Driver.o ${OBJECTDIR}/Drivers/CTMU_Driver.o ${OBJECTDIR}/configuration.o ${OBJECTDIR}/main.o ${OBJECTDIR}/utils.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Drivers/SYSTEM_Driver.o.d ${OBJECTDIR}/Drivers/INTERRUPT_Driver.o.d ${OBJECTDIR}/Drivers/UART_Driver.o.d ${OBJECTDIR}/Drivers/CTMU_Driver.o.d ${OBJECTDIR}/configuration.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/utils.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Drivers/SYSTEM_Driver.o ${OBJECTDIR}/Drivers/INTERRUPT_Driver.o ${OBJECTDIR}/Drivers/UART_Driver.o ${OBJECTDIR}/Drivers/CTMU_Driver.o ${OBJECTDIR}/configuration.o ${OBJECTDIR}/main.o ${OBJECTDIR}/utils.o

# Source Files
SOURCEFILES=Drivers/SYSTEM_Driver.c Drivers/INTERRUPT_Driver.c Drivers/UART_Driver.c Drivers/CTMU_Driver.c configuration.c main.c utils.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/RCMeasure.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Drivers/CTMU_Driver.o: Drivers/CTMU_Driver.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Drivers" 
	@${RM} ${OBJECTDIR}/Drivers/CTMU_Driver.o.d 
	@${RM} ${OBJECTDIR}/Drivers/CTMU_Driver.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Drivers/CTMU_Driver.c  -o ${OBJECTDIR}/Drivers/CTMU_Driver.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Drivers/CTMU_Driver.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/Drivers/CTMU_Driver.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/Drivers/CTMU_Driver.o: Drivers/CTMU_Driver.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Drivers/CTMU_Driver.o.d 
	@${RM} ${OBJECTDIR}/Drivers/CTMU_Driver.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Drivers/CTMU_Driver.c  -o ${OBJECTDIR}/Drivers/CTMU_Driver.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Drivers/CTMU_Driver.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/Drivers/CTMU_Driver.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/RCMeasure.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/RCMeasure.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
